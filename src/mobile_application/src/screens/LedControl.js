...
import {
    ...
    TouchableOpacity, Image, Text, Picker, AsyncStorage,
...
class LedControl extends Component {
    ...
    onRefresh() {
        ...
        AsyncStorage.getItem('accessToken').then(authToken => {
            ...
            Promise.resolve((
                this.props.getLedProfiles(this.props.deviceId, authToken)
            )).then(() => {
                this.props.getLedChannels(this.props.deviceId, authToken);
                this.props.getCurrentValue(this.props.deviceHid, authToken);
    ...
    renderLEDControls() {
        console.log('led 1===============', this.props.ledCurrentData.led1);
                ...
                <View style={{ margin: 10, paddingTop: 10, paddingBottom: 10, flex: 2, elevation: 5, backgroundColor: "#fff", shadowColor: "black", shadowOpacity: 1 }}>
                    ...
                    <ScrollView style={{ marginTop: 10, flex: 1 }}>
                        <View style={{ flexDirection: 'row', margin: 5 }}>
                            ...
                            />
                            <Text style={{ marginLeft: 10 }}>{this.state.channel1Value || 0}%</Text>
                        </View>
                        <View style={{ flexDirection: 'row', margin: 5 }}>
                            ...
                            <Slider
                                ...
                                thumbTintColor='#acd373'
                            />
                            <Text style={{ marginLeft: 10, width: '20%' }}>{this.state.channel2Value || 0}%</Text>
                        </View >
                        <View style={{ flexDirection: 'row', margin: 5 }}>
                            ...
                            <Slider
                                ...
                                thumbTintColor='#acd373'
                            />
                            <Text style={{ marginLeft: 10, width: '20%' }}>{this.state.channel3Value || 0}%</Text>
                        </View>
                        <View style={{ flexDirection: 'row', margin: 5 }}>
                            ...
                            <Slider
                                ...
                                thumbTintColor='#acd373'
                            />
                            <Text style={{ marginLeft: 10, width: '20%' }}>{this.state.channel4Value || 0}%</Text>
                        </View>
                        <View style={{ flexDirection: 'row', margin: 5 }}>
                            ...
                            <Slider
                                ...
                                thumbTintColor='#acd373'
                            />
                            <Text style={{ marginLeft: 10, width: '20%' }}>{this.state.channel5Value || 0}%</Text>
                        </View>
                        <View style={{ flexDirection: 'row', margin: 5 }}>
                            ...
                            <Slider
                                ...
                                thumbTintColor='#acd373'
                            />
                            <Text style={{ marginLeft: 10, width: '20%' }}>{this.state.channel6Value || 0}%</Text>
                        </View>
                            ...
                            <Button
                                onPress={() => {
                                    ...
                                    if (!this.props.deviceStatus) {
                                        ...
                                        this.props.setLedControls(reqBody, this.state.token);
                                    }

                                }}
                                title="Set"
                                textStyle={{ alignSelf: 'center' }}
                                buttonStyle={{ marginTop: 0, marginLeft: 5, width: 60, alignItems: 'center', backgroundColor: Constant.PRIMARY_COLOR }} />
                            <Button
                                onPress={() => {
                                ...
                                title="Clear"
                                textStyle={{ alignSelf: 'center' }}
                                buttonStyle={{ marginTop: 0, marginLeft: 5, width: 60, backgroundColor: Constant.PRIMARY_COLOR, alignItems: 'center' }} />
                        </View>
                    </ScrollView>
                </View>
            )
    ...
    render() {
        if (this.props.retry401Count === 20 && !this.state.enabled401) {
            this.setState({ showProfileModal: false, enabled401: true })
        }
                ...
                <View style={{ margin: 10, marginTop: 15, elevation: 5, backgroundColor: "#fff", shadowColor: "black", shadowOpacity: 1 }}>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 5, alignItems: "center", justifyContent: 'flex-start', margin: 10 }}>
                        ...
                        {this.state.selectedProfileName === '' ?
                            ...
                            :
                            <TouchableOpacity style={[styles.roundButton, { backgroundColor: Constant.PRIMARY_COLOR }]} onPress={() => {
                                this.props.deleteProfile(this.state.token, this.state.selectedProfileId)
                                        ...
                                        <View style={{ marginTop: 20 }} >
                                            <View style={{ flexDirection: 'row', margin: 5, marginLeft: 10 }}>
                                                ...
                                                <Slider
                                                    ...
                                                    thumbTintColor='#acd373'
                                                />
                                                <Text style={{ marginLeft: 10, color: '#fff', width: '20%' }}>{this.state.channel1ValueForProfile}%</Text>
                                            ...
                                            <View style={{ flexDirection: 'row', margin: 5, marginLeft: 10 }}>
                                                ...
                                                <Slider
                                                    ...
                                                    thumbTintColor='#acd373'
                                                />
                                                <Text style={{ marginLeft: 10, color: '#fff', width: '20%' }}>{this.state.channel2ValueForProfile}%</Text>
                                            ...
                                            <View style={{ flexDirection: 'row', margin: 5, marginLeft: 10 }}>
                                                ...
                                                <Slider
                                                    ...
                                                    thumbTintColor='#acd373'
                                                />
                                                <Text style={{ marginLeft: 10, color: '#fff', width: '20%' }}>{this.state.channel3ValueForProfile}%</Text>
                                            ...
                                            <View style={{ flexDirection: 'row', margin: 5, marginLeft: 10 }}>
                                                ...
                                                <Slider
                                                    ...
                                                    thumbTintColor='#acd373'
                                                />
                                                <Text style={{ marginLeft: 10, color: '#fff', width: '20%' }}>{this.state.channel4ValueForProfile}%</Text>
                                            ...
                                            <View style={{ flexDirection: 'row', margin: 5, marginLeft: 10 }}>
                                                ...
                                                <Slider
                                                    ...
                                                    thumbTintColor='#acd373'
                                                />
                                                <Text style={{ marginLeft: 10, color: '#fff', width: '20%' }}>{this.state.channel5ValueForProfile}%</Text>
                                            ...
                                            <View style={{ flexDirection: 'row', margin: 5, marginLeft: 10 }}>
                                                ...
                                                <Slider
                                                    ...
                                                    thumbTintColor='#acd373'
                                                />
                                                <Text style={{ marginLeft: 10, color: '#fff', width: '20%' }}>{this.state.channel6ValueForProfile}%</Text>

                                            </View>
                                        </View>
                                        <View style={{ flexDirection: 'row', marginTop: 10, justifyContent: 'flex-end', marginRight: 40, marginBottom: 10 }}>
                                            <Button
                                                onPress={() => {
                                                    let regEx = /^[a-zA-Z][a-zA-Z_.]{0,1}[ a-z|A-Z|0-9|_.]*$/;

                                                    console.log("hello pressed", regEx.test(this.state.newProfileName.trim()), this.state.newProfileName.trim() === '' || this.state.newProfileName.length > 25 || !regEx.test(this.state.newProfileName.trim()));
                                                    if (this.state.newProfileName.trim() === '' || this.state.newProfileName.length > 25 || !regEx.test(this.state.newProfileName.trim())) {
                                                    ...
                                                    else if (this.state.newProfileDescription > 200) {
                                                        return (
                                                        ...
                                                        this.props.addProfile(reqData, this.state.token);
                                                    }
                                                }}
                                                title='Done'
                                                textStyle={{ alignSelf: 'center' }}
                                            ...
                                            <Button
                                                ...
                                                title='Cancel'
                                                textStyle={{ alignSelf: 'center' }}
                                                buttonStyle={{ backgroundColor: Constant.PRIMARY_COLOR, marginLeft: 5, justifyContent: 'center', alignItems: 'center' }} />
                                        </View>
                                    </View>
                                </View>
                            </Modal>
...
const mapStateToProps = (state) => {
    const { ledProfiles, loading, ledChannelsData, ledCurrentData, isProfileDeletedLoader } = state.device;
    const { retry401Count } = state.auth;
    return { ledProfiles, ledChannelsData, loading, ledCurrentData, isProfileDeletedLoader, retry401Count };
};
