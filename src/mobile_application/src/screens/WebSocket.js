...
import { View, StyleSheet, Text, AsyncStorage, Picker } from "react-native";
            ...
            <View style={styles.mainContainer}>
                ...
                <View style={{ margin: 10, paddingTop: 10, paddingBottom: 10, height: '42%', elevation: 5, backgroundColor: "#fff", shadowColor: "black", shadowOpacity: 1 }}>
                    <Chart
                        ...
                        defaultFontSize={12}
                    />
                    {this.dataList.length > 2 && <Text style={{ marginLeft: 30, color: '#3cba9f' }}>Currentvalue : {this.dataList[this.dataList.length - 1]}</Text>}
                </View>
            </View>
        );
    }
